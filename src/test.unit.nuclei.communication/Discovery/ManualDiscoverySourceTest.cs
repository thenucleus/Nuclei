        ...
        public void StartDiscovery()
        {
            ...
            source.OnEndpointBecomingAvailable +=
                (s, e) =>
                {
                    ...
                    channelVersion = e.ConnectionInformation.ProtocolVersion;
                };

            source.RecentlyConnectedEndpoint(new EndpointId("sendingEndpoint"), new Uri("net.pipe://localhost/apollo_test"));
            ...
            source.RecentlyConnectedEndpoint(newEndpoint, uri);
