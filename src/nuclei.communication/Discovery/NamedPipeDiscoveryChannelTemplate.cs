...
{
    /// <summary>
    /// Defines a named pipe channel type for discovery channels.
    /// </summary>
    internal sealed class NamedPipeDiscoveryChannelTemplate : NamedPipeChannelTemplate, IDiscoveryChannelTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NamedPipeDiscoveryChannelTemplate"/> class.
        /// </summary>
        ...
        /// </exception>
        public NamedPipeDiscoveryChannelTemplate(IConfiguration tcpConfiguration) 
        ...
        {
            return Configuration.HasValueFor(CommunicationConfigurationKeys.NamedPipeDiscoveryPath) ?
                Configuration.Value<string>(CommunicationConfigurationKeys.NamedPipeDiscoveryPath) :
