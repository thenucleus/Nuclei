...
namespace Nuclei.Communication.Interaction
{
    ...
    /// that can be invoked remotely through a <see cref="ISendCommandsToRemoteEndpoints"/>.
    /// </summary>
    /// <design>
    /// The <see cref="ISendCommandsToRemoteEndpoints"/> will generate a proxy object for all the command sets
