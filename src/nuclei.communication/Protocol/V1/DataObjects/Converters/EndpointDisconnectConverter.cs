...
{
    /// <summary>
    /// Converts <see cref="EndpointDisconnectMessage"/> objects to <see cref="EndpointDisconnectData"/> objects and visa versa.
    /// </summary>
    internal sealed class EndpointDisconnectConverter : IConvertCommunicationMessages
    {
        /// <summary>
        ...
        public Type DataTypeToTranslate
        {
            ...
            get
            {
                return typeof(EndpointDisconnectData);
            }
        }
