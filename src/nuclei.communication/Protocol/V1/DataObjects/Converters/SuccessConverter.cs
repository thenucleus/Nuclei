...
{
    /// <summary>
    /// Converts <see cref="SuccessMessage"/> objects to <see cref="SuccessData"/> objects and visa versa.
    /// </summary>
    internal sealed class SuccessConverter : IConvertCommunicationMessages
    {
        /// <summary>
            ...
            return new SuccessData
                {
                    ...
                    InResponseTo = successMessage.InResponseTo,
                    Sender = successMessage.Sender,
                };
        }
    }
}
