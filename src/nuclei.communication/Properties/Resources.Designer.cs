...
namespace Nuclei.Communication.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Signaling new connection through manual discovery. Connection to endpoint {0} via channel {1} at {2}.
        /// </summary>
        internal static string Log_Messages_ManualDiscoveryOfRemoteEndpoint_WithConnectionInformation {
            get {
                return ResourceManager.GetString("Log_Messages_ManualDiscoveryOfRemoteEndpoint_WithConnectionInformation", resourceCulture);
            }
        }
